                            ...
                            <div class="register_wrap tab-content">
                                <div class="tab-pane fade show active" id="signin_tab" role="tabpanel">
                                    <form action="{{ route('customer.login.store') }}" method="POST">
                                        ...
                                        @endif
                                        @if (session('PassNotification'))
                                        <div class="alert alert-info">{{ session('PassNotification') }}</div> 
                                        @endif
                                        ...
                                        <div class="form_item_wrap">
                                            <div class="text-center"><button type="submit" class="btn btn_primary">Sign In</button></div>
                                        </div>
                                    </form> {{--login part end--}}
